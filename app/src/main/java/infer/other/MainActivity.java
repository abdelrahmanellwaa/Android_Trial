...
protected void branch_42(Bundle savedInstanceState) {
    source().toString();
  }

protected void branch_42_updated(Bundle savedInstanceState) {
    source().toString();
  }

protected void branch_42_updated_last(Bundle savedInstanceState) {
    source().toString();
  }
